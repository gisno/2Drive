...
def main():
    ...
    # Check of de gebruiker al geverifieerd is
    if "authenticated" not in st.session_state:
        st.session_state.authenticated = False

    # Als de gebruiker nog niet geverifieerd is, toon wachtwoordveld
    if not st.session_state.authenticated:
        wachtwoord = st.text_input("Voer het wachtwoord in:", type="password")
        ...
        return  # Stop de verdere uitvoering van de app
